# PT Application Report (M=16, K=32, N=16)
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `host_reduce_direct_tiled_matmul` | 273.0 | measured | 226.0 | 4 | 2 | 32 | 0 | 256 |
| `host_reduce_load_then_matmul` | 283.0 | measured | 246.0 | 4 | 2 | 32 | 0 | 256 |
| `pt_matadd_reduce` | 415.0 | measured | 319.0 | 5 | 3 | 48 | 1 | 0 |
...
- Reasoning:
  ...
  - 当前 winner 基于 `/Users/yucheng/Documents/GitHub/flash_atten/app/pt_tiled_gemm/out/verify_metrics_m16_k32_n16.json` 中的实测结果排序。
...
- failures: 0
- errors: 0
- results_xml: `/Users/yucheng/Documents/GitHub/flash_atten/app/pt_tiled_gemm/out/cocotb/m16_k32_n16/icarus/results.xml`
- metrics_path: `/Users/yucheng/Documents/GitHub/flash_atten/app/pt_tiled_gemm/out/verify_metrics_m16_k32_n16.json`
