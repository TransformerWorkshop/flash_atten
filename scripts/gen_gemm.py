#!/usr/bin/env python3
"""Generate a parameterized GEMM module with grouped output streaming."""
...
GEMM_TEMPLATE = Template(
	"""module $MODULE_NAME #(
	parameter WIDTH = $WIDTH_DEFAULT,
	parameter X_DIM = $X_DIM_DEFAULT,
	parameter Y_DIM = $Y_DIM_DEFAULT,
...
def build_gemm_verilog(width: int, x_dim: int, y_dim: int, module_name: str = "GEMM") -> str:
	return GEMM_TEMPLATE.substitute(
